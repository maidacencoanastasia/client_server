...
while True:
    ...
    if turn_msg == "YOUR_TURN":
        ...
        while True:
            ...
            if move.isdigit() and int(move) >= 0 and int(move) <= 8 and board[int(move)] != "X" and board[int(move)] != "O":
                break
            print("Invalid move.")
        # send move to server
